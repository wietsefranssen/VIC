                    ...
                    nc_var_struct     *nc_var)
{
    ...
    int OUT_DAM_OP_DISCHARGE = list_search_id(outvar_types,
                      ...
                      nc_var_struct  *nc_var)
{
    ...
    int          OUT_DAM_VOLUME = list_search_id(outvar_types, "OUT_DAM_VOLUME");
    int          OUT_DAM_DISCHARGE = list_search_id(outvar_types,
                                                    "OUT_DAM_DISCHARGE");
    int          OUT_DAM_AREA = list_search_id(outvar_types, "OUT_DAM_AREA");
    int          OUT_DAM_HEIGHT = list_search_id(outvar_types, "OUT_DAM_HEIGHT");
    int          OUT_DAM_OP_DISCHARGE = list_search_id(outvar_types,
                                                       "OUT_DAM_OP_DISCHARGE");
    int          OUT_DAM_OP_VOLUME = list_search_id(outvar_types,
                                                    "OUT_DAM_OP_VOLUME");
    int          OUT_DAM_OP_MONTH = list_search_id(outvar_types,
                                                   "OUT_DAM_OP_MONTH");
