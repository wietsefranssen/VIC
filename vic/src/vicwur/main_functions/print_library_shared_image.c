                ...
                location_struct *loc)
{
    sprintf(str,
            ...
            loc->nveg, loc->nelev, loc->global_idx, loc->io_idx, loc->local_idx);
}
 ...
 *****************************************************************************/
void
print_elev_con_map(elev_con_map_struct *elev_con_map)
{
    fprintf(LOG_DEST, "elev_con_map:\n");
    fprintf(LOG_DEST, "\tne_active: %zd\n", elev_con_map->ne_active);
}
