 ...
 *****************************************************************************/
void RID_start(void);      // read global parameters for routing
void RID_alloc(void);      // allocate memory
void RID_init(void);       // initialize model parameters from parameter files
void rout_run(void);        // run routing over the domain
void RID_write(void);      // write routine for routing
void RID_finalize(void);   // clean up routine for routing
