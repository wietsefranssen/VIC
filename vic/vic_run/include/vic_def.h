...
typedef struct {
    ...
    unsigned short int forceday[N_FORCE_FILES];  /**< day forcing files starts */
    unsigned int forcesec[N_FORCE_FILES];          /**< seconds since midnight when forcing
                                          files starts */
    unsigned short int forcemonth[N_FORCE_FILES];  /**< month forcing files starts */
    unsigned short int forceoffset[N_FORCE_FILES];  /**< counter to keep track of offset in reading
                                           forcing files; updated after every read */
    unsigned int forceskip[N_FORCE_FILES];   /**< number of model time steps to skip at
                                      the start of the forcing file */
    unsigned short int forceyear[N_FORCE_FILES];  /**< year forcing files start */
