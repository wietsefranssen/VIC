...
double calc_surf_energy_bal(double, double, double, double, double, double,
                            ...
                            int, unsigned short int, double *, double *,
...
int snow_intercept(double, double, double, double, double, double, double,
                   ...
                   int, int, int,
                   unsigned short int, double *, double *, force_data_struct *,
                   layer_data_struct *,
                   soil_con_struct *,
                   veg_var_struct *);
...
int surface_fluxes(bool, double, double, double, double, double *, double *,
                   ...
                   double *, double *, double *, size_t, size_t,
                   unsigned short int, double,
                   unsigned short int, unsigned short int, force_data_struct *,
                   dmy_struct *,
                   energy_bal_struct *, global_param_struct *,
                   cell_data_struct *,
...
int run_general(force_data_struct *, all_vars_struct *, dmy_struct *,
